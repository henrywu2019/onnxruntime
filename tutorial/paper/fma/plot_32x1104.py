...
ax1.set_title("ZPZR vs. SOTA(Input=256x32x1104,Kernel=3x3,AMD EPYC 7J13,2.2GHz,Cache 64/64/1.6),AVX2")
ax1.legend()
...
ax2.set_xlabel("Kernel Batch Size(K)")
...
plt.savefig("zpzr_vs_sota.e3.32x1104.png")
