    ...
    REP2(w_,0,ca.OW,8){
      ...
      REP(h_,2,ca.H-2){ // y01, y02
        REP(c_,cbase,cstop){
          ...
          y00 = _mm256_loadu_ps(input + i_offset++);
          y03 = _mm256_set1_ps(fr[kid(k,c_,0,1,0)]); y06 = _mm256_fmadd_ps(y00, y03, y06); y03 = _mm256_set1_ps(fr[kid(k,c_,1,1,0)]); y05 = _mm256_fmadd_ps(y00, y03, y05); y03 = _mm256_set1_ps(fr[kid(k,c_,2,1,0)]); y04 = _mm256_fmadd_ps(y00, y03, y04);
          y03 = _mm256_set1_ps(fr[kid(k,c_,0,1,1)]); y09 = _mm256_fmadd_ps(y00, y03, y09); y03 = _mm256_set1_ps(fr[kid(k,c_,1,1,1)]); y08 = _mm256_fmadd_ps(y00, y03, y08); y03 = _mm256_set1_ps(fr[kid(k,c_,2,1,1)]); y07 = _mm256_fmadd_ps(y00, y03, y07);
          y03 = _mm256_set1_ps(fr[kid(k,c_,0,1,2)]); y12 = _mm256_fmadd_ps(y00, y03, y12); y03 = _mm256_set1_ps(fr[kid(k,c_,1,1,2)]); y11 = _mm256_fmadd_ps(y00, y03, y11); y03 = _mm256_set1_ps(fr[kid(k,c_,2,1,2)]); y10 = _mm256_fmadd_ps(y00, y03, y10);
          y03 = _mm256_set1_ps(fr[kid(k,c_,0,1,3)]); y15 = _mm256_fmadd_ps(y00, y03, y15); y03 = _mm256_set1_ps(fr[kid(k,c_,1,1,3)]); y14 = _mm256_fmadd_ps(y00, y03, y14); y03 = _mm256_set1_ps(fr[kid(k,c_,2,1,3)]); y13 = _mm256_fmadd_ps(y00, y03, y13);

          y00 = _mm256_loadu_ps(input + i_offset++);
          y03 = _mm256_set1_ps(fr[kid(k,c_,0,2,0)]); y06 = _mm256_fmadd_ps(y00, y03, y06); y03 = _mm256_set1_ps(fr[kid(k,c_,1,2,0)]); y05 = _mm256_fmadd_ps(y00, y03, y05); y03 = _mm256_set1_ps(fr[kid(k,c_,2,2,0)]); y04 = _mm256_fmadd_ps(y00, y03, y04);
          y03 = _mm256_set1_ps(fr[kid(k,c_,0,2,1)]); y09 = _mm256_fmadd_ps(y00, y03, y09); y03 = _mm256_set1_ps(fr[kid(k,c_,1,2,1)]); y08 = _mm256_fmadd_ps(y00, y03, y08); y03 = _mm256_set1_ps(fr[kid(k,c_,2,2,1)]); y07 = _mm256_fmadd_ps(y00, y03, y07);
          y03 = _mm256_set1_ps(fr[kid(k,c_,0,2,2)]); y12 = _mm256_fmadd_ps(y00, y03, y12); y03 = _mm256_set1_ps(fr[kid(k,c_,1,2,2)]); y11 = _mm256_fmadd_ps(y00, y03, y11); y03 = _mm256_set1_ps(fr[kid(k,c_,2,2,2)]); y10 = _mm256_fmadd_ps(y00, y03, y10);
          y03 = _mm256_set1_ps(fr[kid(k,c_,0,2,3)]); y15 = _mm256_fmadd_ps(y00, y03, y15); y03 = _mm256_set1_ps(fr[kid(k,c_,1,2,3)]); y14 = _mm256_fmadd_ps(y00, y03, y14); y03 = _mm256_set1_ps(fr[kid(k,c_,2,2,3)]); y13 = _mm256_fmadd_ps(y00, y03, y13);
        }
